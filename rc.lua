...
--config.terminal = "urxvt -e /home/nopcall/.tmuxen/tmuxen"
...
config.wallpaper = os.getenv("HOME") .. "/Pictures/background/"
-- Remaining modules
...
--loadrc("temp")		-- widgets configuration
loadrc("tags")			-- tags handling
--loadrc("xlock")			-- lock screen
loadrc("signals")		-- window manager behaviour 鼠标移动获取焦点
