...
theme = {}
theme.icons = icons
--theme.wallpaper_cmd = { "awsetbg ".. awful.util.getdir("config") .."/wallpapers/background.jpg"}
--theme.wallpaper_cmd = { "awsetbg " .. awful.util.getdir("config") .."/wallpapers/background_day.jpg"}
--theme.wallpaper_cmd = { "feh --bg-scale " .. awful.util.getdir("config") .."/wallpapers/background_day.jpg" .. "&"}
--theme.wallpaper_cmd = { "/home/nopcall/bin/randompics.pl"}
...
theme.border_focus  = "#8E2323"--" #FF7F00EE"
