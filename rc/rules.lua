...
awful.rules.rules = {
   ...
   { rule = { },-- it's buddy_list
     properties = { border_width = beautiful.border_width,
                    ...
                    size_hints_honor = false,           --添加这个能让emacs全屏
   ...
   { rule_any = { class = { "Iceweasel", "Firefox", "Chromium", "Google-chrome","Conkeror" } },
     callback = function(c)
   ...
   -- Floating windows
   { rule_any = { class = { "Display.im6","key-mon","Wine", "Gimp","Smplayer", "Mplayer" } },
